...
<!-- <form action ="addmoney.php"method="post">    -->
            <div class="col-12">
              ...
              <div class="col-12">
              <label for="text" class="form-label">匯款金額</label>
...
$SQL="INSERT INTO moneytransfer (no, uNo,amount, inOrOut, comfirm, askDate, comfirmDate) VALUES (NULL,'$uNo','$amount','I',default ,default ,default )";
