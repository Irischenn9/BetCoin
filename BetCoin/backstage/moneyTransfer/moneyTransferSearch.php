        ...
        匯款管理查詢</br>
            ...
            if(isset($_POST["search"])){
                ...
                if($searchResult){
                    ...
                    <form action="moneyTransferSearch.php" method="post" enctype="multipart/form-data">
                    ...
                    <tr>
                        <th>no</th><th>玩家編號</th><th>數量</th><th>I存入/O取出</th><th>認證</th><th colspan="2">詢問時間</th><th colspan="2">認證時間</th>
                    </tr>    
                    <?php
                    while($row=mysqli_fetch_assoc($searchResult)){
                        ...
                        <td colspan='2'>".$comfirmDateCheck."</td>";
                        echo "</tr>";
                    }
                    echo "</table>";
                }
                ...
                <table border="3px" style="border-collapse:collapse;">
                    ...
                    <tr>
                    <th>no</th><th>玩家編號</th><th>數量</th><th>I存入/O取出</th><th>認證</th><th colspan="2">詢問時間</th></th><th colspan="2">認證時間</th>
                    </tr>
                </form>
                    <?php
