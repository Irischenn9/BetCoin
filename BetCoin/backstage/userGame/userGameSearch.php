        ...
        參賽管理查詢</br>
            ...
            if(isset($_POST["search"])){
                ...
                if($searchResult){
                    ...
                    <form action="userGameSearch.php" method="post" enctype="multipart/form-data">
                    ...
                    <tr>
                        <th>no</th><th>賽局編號</th><th>玩家編號</th><th>投注隊伍編號</th><th>投注金額</th><th colspan="2">投注時間</th>
                    </tr>    
                    <?php
                    while($row=mysqli_fetch_assoc($searchResult)){
                        ...
                        echo "<tr>";
                        echo "<td>".$row["no"]."</td><td>".$row["gNo"]."-".$team1["teamName"]." vs ".$team2["teamName"]."</td><td>".$row["uNo"]."-".$user["email"]."</td><td>".$row["tNo"]."-".$userTeam["teamName"]."</td><td>".$row["betAmount"]."</td><td colspan='2'>".$row["date"]."</td>";
                        echo "</tr>";
                    }
                    echo "</table>";
                }
