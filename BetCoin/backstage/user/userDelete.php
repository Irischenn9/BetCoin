<?php 
    ...
    if(isset($_GET["no"])){
        $no=$_GET["no"];
        $SQLDelete="DELETE FROM users WHERE no='$no'";
    ...
    <body>
        ...
        帳號管理刪除</br>
            ...
            if(isset($_POST["search"])){
                ...
                $SQLSearch="SELECT * FROM users $no $email $pwd $bankAccount $role $name";
                ...
                if($searchResult){
                    ...
                    <tr style="background-color:#EAEAEA;">
                        <td><input type="text" name="no"></td><td><input type="email" name="email"></td>
                        <td><input type="text" name="name"></td><td><input type="text" name="pwd"></td>
                    ...
                    <tr>
                        <th>no</th><th>電子信箱</th><th>姓名</th><th>密碼</th><th>郵局帳號</th><th>權限</th><th>刪除</th>
                    </tr>    
                    <?php
                    while($row=mysqli_fetch_assoc($searchResult)){
                        ...
                        <td>             
                            <a href="<?php echo "userDelete.php?no=".$row["no"]?>">
