            ...
            if(isset($_POST["search"])){
                ...
                if($searchResult){
                    ...
                    <tr class="tableTitle" style="background-color:#6B6B6B;">
                        <th>no</th><th>電子信箱</th><th>姓名</th><th>密碼</th><th>郵局帳號</th><th>權限</th>
                    </tr>
                    <form action="userSearch.php" method="post" enctype="multipart/form-data">
                    ...
                    <tr>
                        <td colspan="6" style="text-align:center; background-color:#EAEAEA;"><input type="submit" name="search" value="查詢" style="width:30%;"></td>
                    </tr>
                    </form>
                    <tr>
                        <td colspan="6" style="text-align:center; background-color:#6B6B6B;">所有資料</td> 
                    </tr>
                    <tr>
                    <th>no</th><th>電子信箱</th><th>姓名</th><th>密碼</th><th>郵局帳號</th><th>權限</th>
                    </tr>    
