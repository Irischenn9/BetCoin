        ...
        賽局管理更新</br>
            ...
            if(isset($_POST["search"])){
                ...
                if($searchResult){
                    ...
                    <tr>
                       <th>no</th><th>隊伍1</th><th>隊伍2</th><th>隊伍1賠率</th><th>隊伍2賠率</th><th>隊伍1勝負</th><th>頻道參數</th><th>賽局開始時間</th><th>更新</th>
                    </tr>    
                    <?php
                    while($row=mysqli_fetch_assoc($searchResult)){
                        ...
                        <td>             
                            <a href="javascript:window.open('<?php echo "gameUpdateConfirming.php?no=".$row["no"]?>','mypopuptitle','width=1400px,height=200px')">
