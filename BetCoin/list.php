            ...
            if(isset($_POST["search"])){
                ...
                if($searchResult){
                    ...
                    while($row=mysqli_fetch_assoc($searchResult)){
                        ...
                        // echo "<tr>";
                        // echo "<td colspan='2'>".$row["gameStartTime"]."</td><td>".$team1Name["teamName"]."</td><td>".$team2Name["teamName"]."</td>";
                ...
                <!-- <table border="3px" style="border-collapse:collapse;"> -->
                    ...
                    if($result){
                        ...
                        echo "<td  valign='middle'>".$team2Name["teamName"]."</td>";
                            ...
                            ?>
                             <td>             
                             <input type="button" name="進入比賽" value="進入比賽" onclick="location.href='race.php?gno=<?php echo $row['no']; ?>'">  
                          </td>
