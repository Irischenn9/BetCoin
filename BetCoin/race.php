    ...
    <div class="container">
      ...
      <!-- <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3"> -->
        <center><div class="col">
            ...
            <br>
            <!-- <iframe width="500" height="300" src="https://www.youtube.com/embed/ title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>            -->
            ...
            <table style="border: 1px " >
                            ...
                            <td><h3> <span class="badge bg-secondary"><?php  echo $team1Name["teamName"]."</br>".$row["team1Odds"]; ?> </span></p></td>
                            ...
                            <td> <h3><span class="badge bg-secondary"><?php  echo $team2Name["teamName"]."</br>".$row["team2Odds"]; ?></span></p></td>
                ...
                <?php
                  ...
                  <?php
                    ...
                    ?>
                    <center><button class="w-45 btn btn-primary btn-lg"  type="submit" onclick="location.href='login.php'">&emsp;&emsp; &emsp;  &emsp; &emsp; &emsp;&emsp; &emsp; 開始下注&emsp;&emsp;  &emsp; &emsp; &emsp; &emsp; &emsp; &emsp; </button>  </center>
                    <?php
                  }
                ?>
        </center>
